...
user3 = User.create!(first_name: "Lukas", last_name: "Johansson", email: "lukas@gmail.com", password: "123456", city: "Munich", birthday: "09.09.2001", position: "RB")
...
user19 = User.create!(first_name: "Pierre", last_name: "Gautier", email: "pierre@gmail.com", password: "123456", city: "Stockholm", birthday: "09.09.1997", position: "ST")
...
user21 = User.create!(first_name: "Anton", last_name: "Pergold", email: "anton@gmail.com", password: "123456", city: "Stockholm", birthday: "09.09.2000", position: "ST")
...
user24 = User.create!(first_name: "Max", last_name: "Markus", email: "max@gmail.com", password: "123456", city: "Stockholm", birthday: "09.09.2002", position: "CAM")
user25 = User.create!(first_name: "Annabelle", last_name: "Wöllner", email: "annabelle@gmail.com", password: "123456", city: "Stockholm", birthday: "09.09.2002", position: "LM")
...
user30 = User.create!(first_name: "Schend", last_name: "Dolino", email: "schend@gmail.com", password: "123456", city: "Stockholm", birthday: "09.10.2002", position: "CF")
user31 = User.create!(first_name: "Richard", last_name: "Wagner", email: "richard@gmail.com", password: "123456", city: "Stockholm", birthday: "09.09.2003", position: "CF")
user32 = User.create!(first_name: "Josephine", last_name: "Groß", email: "josephine@gmail.com", password: "123456", city: "Stockholm", birthday: "09.09.2004", position: "CF")
...
MatchUser.create!(user: ruben, team: "A", match: match4)
MatchUser.create!(user: carl, team: "B", match: match4)
...
ClubRequest.create!(user: user30, club: club3, status: "pending")
ClubRequest.create!(user: user31, club: club3, status: "pending")
ClubRequest.create!(user: user32, club: club3, status: "pending")
